...
option(USE_PROFILER "USE XPU Legacy Profiler in build." ON)
option(USE_KINETO "USE PyTorch Kineto in build." ON)
if (WIN32 OR MSVC)
  set(USE_KINETO OFF)
endif()
cmake_dependent_option(USE_ONETRACE "Use Intel onetrace tool" ON USE_KINETO OFF)
cmake_dependent_option(USE_PTI "Use Intel PTI library" OFF USE_KINETO OFF)
...
option(USE_XETLA "Use XeTLA based customer kernels" OFF)
if(WINDOWS)
  set(USE_XETLA OFF)
endif()
...
function (print_xpu_config_summary)
  ...
  if (USE_ONETRACE)
    message(STATUS "  oneTrace include      : ${ONETRACE_INCLUDE_DIRS}")
  endif(USE_ONETRACE)
  ...
  if (USE_KINETO)
    message(STATUS "  USE_ONETRACE          : ${USE_ONETRACE}")
